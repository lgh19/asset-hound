...
def to_dict_for_csv(asset: Asset):
    return {
        ...
        'organization_name': asset.organization.name if organization is not None else '',
        'organization_phone': asset.organization.phone if organization is not None else '',
        'organization_email': asset.organization.email if organization is not None else '',
